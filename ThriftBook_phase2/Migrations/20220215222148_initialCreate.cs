    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 100001, null, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1995), 21.50m });

            migrationBuilder.InsertData(
                table: "Invoice",
                columns: new[] { "TransactionId", "BookId", "BuyerId", "DateOfTransaction", "TotalPrice" },
                values: new object[] { 100002, null, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(2007), 22m });

            migrationBuilder.InsertData(
                table: "Invoice",
                columns: new[] { "TransactionId", "BookId", "BuyerId", "DateOfTransaction", "TotalPrice" },
                values: new object[] { 100003, null, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1999), 13.75m });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 1, 100001 });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 5, 100001 });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 2, 100002 });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 4, 100002 });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 3, 100003 });

            migrationBuilder.InsertData(
                table: "BookInvoice",
                columns: new[] { "BookId", "TransactionId" },
                values: new object[] { 5, 100003 });
